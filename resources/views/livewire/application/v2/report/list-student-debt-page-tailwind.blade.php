...
<div class="space-y-4" x-data="{ showStudentModal: false, showFilters: @entangle('showFilters') }">
    {{-- Breadcrumb --}}
    ...
    <x-content.main-content-page>
        ...
        @if (!$categoryFeeId)
            <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600 dark:border-blue-500 rounded-lg p-4 mb-4">
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Nom de l'élève</th>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Section/Option/Classe</th>
                                <th class="px-4 py-3 text-center text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Mois Inscrip.</th>
                                <th class="px-4 py-3 text-center text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Mois Dus</th>
                                <th class="px-4 py-3 text-center text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Mois Payés</th>
                                <th class="px-4 py-3 text-center text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Mois Impayés</th>
                                <th class="px-4 py-3 text-right text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Dette ({{ $currency }})</th>
        ...
        @elseif ($categoryFeeId)
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-12" wire:loading.remove.delay.longer>
                <div class="text-center">
                    <div class="bg-green-100 dark:bg-green-900/30 rounded-full p-6 w-24 h-24 mx-auto mb-4 flex items-center justify-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
                        Tous les élèves sont à jour avec leurs paiements ou aucun élève ne correspond aux critères sélectionnés.
                    </p>
                </div>
            </div>
        @endif
        ...
        @if ($selectedStudent)
            <div class="fixed inset-0 z-50 overflow-y-auto"
                ...
                <div class="fixed inset-0 bg-linear-to-br from-gray-900/85 via-red-900/40 to-purple-900/60 backdrop-blur-md transition-all"
                     ...
                     @click="$wire.closeStudentDetails()"></div>
                ...
                <div class="flex min-h-full items-center justify-center p-4">
                    <div class="relative w-full max-w-4xl bg-white/98 dark:bg-gray-800/98 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-200/60 dark:border-gray-700/60 overflow-hidden"
                        ...
                        {{-- Header avec gradient et icône élève --}}
                        <div class="relative bg-linear-to-r from-red-600 via-red-500 to-orange-600 px-8 py-6 overflow-hidden">
                            ...
                            <div class="relative flex items-center justify-between">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-white font-bold text-2xl">{{ $selectedStudent['student_name'] }}</h3>
                                        <p class="text-white/90 text-sm mt-1 flex items-center gap-2">
                                            <span class="bg-white/25 backdrop-blur-sm px-2.5 py-0.5 rounded-full text-xs font-medium">
                                ...
                                <button wire:click="closeStudentDetails"
                                        class="bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-xl p-2 transition-all duration-200 hover:scale-110">
                        ...
                        <div class="px-8 py-6 max-h-[calc(100vh-240px)] overflow-y-auto">
                            ...
                            <div class="mb-6">
                                <h4 class="text-gray-900 dark:text-gray-100 font-semibold text-sm uppercase tracking-wide mb-3 flex items-center gap-2">
                                    <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
                                        <i class="bi bi-mortarboard text-blue-600 dark:text-blue-400"></i>
                                    </div>
                                    Informations Académiques
                                </h4>
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    <div class="group bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-900/10 rounded-xl p-4 border border-blue-200/50 dark:border-blue-800/50 hover:shadow-md transition-all duration-200">
                                        <div class="flex items-center gap-3">
                                            <div class="bg-blue-100 dark:bg-blue-900/40 rounded-lg p-2.5">
                                                <i class="bi bi-diagram-3 text-blue-600 dark:text-blue-400 text-lg"></i>
                                            </div>
                                            <div>
                                                <p class="text-xs text-blue-600 dark:text-blue-400 font-medium uppercase tracking-wide mb-0.5">Section</p>
                                                <p class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $selectedStudent['section_name'] }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="group bg-gradient-to-br from-purple-50 to-purple-100/50 dark:from-purple-900/20 dark:to-purple-900/10 rounded-xl p-4 border border-purple-200/50 dark:border-purple-800/50 hover:shadow-md transition-all duration-200">
                                        <div class="flex items-center gap-3">
                                            <div class="bg-purple-100 dark:bg-purple-900/40 rounded-lg p-2.5">
                                                <i class="bi bi-bookmark text-purple-600 dark:text-purple-400 text-lg"></i>
                                            </div>
                                            <div>
                                                <p class="text-xs text-purple-600 dark:text-purple-400 font-medium uppercase tracking-wide mb-0.5">Option</p>
                                                <p class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $selectedStudent['option_name'] }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="group bg-gradient-to-br from-indigo-50 to-indigo-100/50 dark:from-indigo-900/20 dark:to-indigo-900/10 rounded-xl p-4 border border-indigo-200/50 dark:border-indigo-800/50 hover:shadow-md transition-all duration-200">
                                        <div class="flex items-center gap-3">
                                            <div class="bg-indigo-100 dark:bg-indigo-900/40 rounded-lg p-2.5">
                                                <i class="bi bi-door-open text-indigo-600 dark:text-indigo-400 text-lg"></i>
                                            </div>
                                            <div>
                                                <p class="text-xs text-indigo-600 dark:text-indigo-400 font-medium uppercase tracking-wide mb-0.5">Classe</p>
                                                <p class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $selectedStudent['class_room_name'] }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    <div class="bg-gradient-to-br from-green-50 to-emerald-100/50 dark:from-green-900/20 dark:to-green-900/10 rounded-xl p-4 border border-green-200/50 dark:border-green-800/50">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <p class="text-xs text-green-600 dark:text-green-400 font-medium uppercase tracking-wide mb-1">Date d'inscription</p>
                                                <p class="text-base font-bold text-gray-900 dark:text-gray-100">{{ $selectedStudent['registration_date'] }}</p>
                                            </div>
                                            <i class="bi bi-calendar3 text-green-600/30 dark:text-green-400/30 text-3xl"></i>
                                        </div>
                                    </div>
                                    <div class="bg-gradient-to-br from-teal-50 to-cyan-100/50 dark:from-teal-900/20 dark:to-teal-900/10 rounded-xl p-4 border border-teal-200/50 dark:border-teal-800/50">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <p class="text-xs text-teal-600 dark:text-teal-400 font-medium uppercase tracking-wide mb-1">Mois d'inscription</p>
                                                <p class="text-base font-bold text-gray-900 dark:text-gray-100">{{ $selectedStudent['registration_month'] }}</p>
                                            </div>
                                            <i class="bi bi-calendar-month text-teal-600/30 dark:text-teal-400/30 text-3xl"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-6">
                                <h4 class="text-gray-900 dark:text-gray-100 font-semibold text-sm uppercase tracking-wide mb-3 flex items-center gap-2">
                                    <div class="w-8 h-8 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg flex items-center justify-center">
                                        <i class="bi bi-cash-stack text-yellow-600 dark:text-yellow-400"></i>
                                    </div>
                                ...
                                <div class="bg-gradient-to-br from-yellow-50 to-amber-100/50 dark:from-yellow-900/20 dark:to-yellow-900/10 rounded-xl p-5 border-l-4 border-yellow-500 dark:border-yellow-600">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        @foreach ($selectedStudent['unpaid_months'] as $month)
                                            <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-semibold bg-yellow-200 dark:bg-yellow-800/50 text-yellow-900 dark:text-yellow-100 border border-yellow-400 dark:border-yellow-600 shadow-sm">
                            ...
                            {{-- Section Montants avec cartes mises en valeur --}}
                            <div class="mb-6">
                                <h4 class="text-gray-900 dark:text-gray-100 font-semibold text-sm uppercase tracking-wide mb-3 flex items-center gap-2">
                                    <div class="w-8 h-8 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center">
                                        <i class="bi bi-calculator text-purple-600 dark:text-purple-400"></i>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="bg-gradient-to-br from-red-50 via-red-100/50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/10 rounded-2xl p-5 border-2 border-red-300/50 dark:border-red-700/50 shadow-lg">
                                        <div class="flex items-start justify-between mb-3">
                                            <div>
                                                ...
                                                <p class="text-gray-500 dark:text-gray-400 text-xs">Somme à régler</p>
                                            </div>
                                            <div class="bg-red-200 dark:bg-red-900/40 rounded-xl p-2.5">
                                                <i class="bi bi-wallet2 text-red-600 dark:text-red-400 text-xl"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="bg-gradient-to-br from-green-50 via-green-100/50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/10 rounded-2xl p-5 border-2 border-green-300/50 dark:border-green-700/50 shadow-lg">
                                        <div class="flex items-start justify-between mb-3">
                                            <div>
                                                <p class="text-xs text-green-600 dark:text-green-400 font-semibold uppercase tracking-wide mb-1">Montant Payé</p>
                                                <p class="text-gray-500 dark:text-gray-400 text-xs">Somme versée</p>
                                            </div>
                                            <div class="bg-green-200 dark:bg-green-900/40 rounded-xl p-2.5">
                                                <i class="bi bi-check-circle-fill text-green-600 dark:text-green-400 text-xl"></i>
                                            </div>
                                        </div>
                                        <p class="text-3xl font-black text-green-700 dark:text-green-300">
                                ...
                                {{-- Dette totale mise en avant --}}
                                <div class="mt-4 relative bg-gradient-to-r from-red-600 via-red-500 to-orange-600 rounded-2xl p-6 shadow-2xl overflow-hidden">
                                    <div class="absolute inset-0 bg-black/10"></div>
                                    <div class="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
                                    <div class="absolute bottom-0 left-0 w-40 h-40 bg-black/10 rounded-full translate-y-1/2 -translate-x-1/2"></div>

                                    <div class="relative flex items-center justify-between">
                                        <div>
                                            <div class="flex items-center gap-2 mb-2">
                                                <i class="bi bi-exclamation-octagon-fill text-white text-xl"></i>
                                                <p class="text-white/90 font-bold uppercase tracking-wider text-sm">Dette Totale</p>
                                            </div>
                                        ...
                                        @if ($selectedStudent['responsible_name'])
                                            <div class="bg-gradient-to-br from-indigo-50 to-indigo-100/50 dark:from-indigo-900/20 dark:to-indigo-900/10 rounded-xl p-4 border border-indigo-200/50 dark:border-indigo-800/50">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p class="text-xs text-indigo-600 dark:text-indigo-400 font-medium uppercase tracking-wide mb-0.5">Nom</p>
                                                        <p class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $selectedStudent['responsible_name'] }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                                        @if ($selectedStudent['responsible_phone'])
                                            <div class="bg-gradient-to-br from-violet-50 to-violet-100/50 dark:from-violet-900/20 dark:to-violet-900/10 rounded-xl p-4 border border-violet-200/50 dark:border-violet-800/50">
                                                <div class="flex items-center gap-3">
                                                    <div class="bg-violet-100 dark:bg-violet-900/40 rounded-lg p-2.5">
                                                        <i class="bi bi-telephone text-violet-600 dark:text-violet-400 text-lg"></i>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs text-violet-600 dark:text-violet-400 font-medium uppercase tracking-wide mb-0.5">Téléphone</p>
                                                        <p class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $selectedStudent['responsible_phone'] }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                        ...
                        <div class="bg-gradient-to-r from-gray-50 to-gray-100/80 dark:from-gray-700/80 dark:to-gray-700/60 backdrop-blur-sm px-8 py-5 border-t border-gray-200/50 dark:border-gray-600/50 flex justify-end gap-3">
                            <button wire:click="closeStudentDetails"
