        ...
        <form wire:submit='handlerSubmit'>
            <div class="d-flex justify-content-center">
                <div class="avatar-wrapper mt-2">
                    @if ($school?->logo != null)
                        <img id="avatar-preview" src="{{ asset('storage/' . $school?->logo) }}" alt="logo">
                    @else
                        <img id="avatar-preview"
                            src="{{ $form->logo != null ? $form->logo->temporaryUrl() : asset('images/defautl-user.jpg') }}"
                            alt="logo">
                    @endif
                    <div class="avatar-edit">
                        <input type="file" wire:model.live='form.logo' id="avatar-upload" accept="image/*">
