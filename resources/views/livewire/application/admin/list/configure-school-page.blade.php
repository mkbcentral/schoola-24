        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center">
                                <x-form.app-button wire:click='newUserAdmin' textButton="Envoyer mail du compte"
                                    data-bs-toggle="modal" data-bs-target="#form-user-config"
                                    icon="bi bi-envelope-arrow-up" class="btn-primary mt-2 me-2" />
                    ...
                    @else
                        <x-form.app-button wire:click='newUserAdmin' textButton="Ouvrir compte admin"
                            data-bs-toggle="modal" data-bs-target="#form-user-admin" icon="bi bi-person-fill-gear"
