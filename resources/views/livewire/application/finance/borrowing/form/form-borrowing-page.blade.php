<div>
    <div class="card">
        <div class="card-header">
            <h4>
                <i class="{{ $moneyBorrowing == null ? 'bi bi-plus-circle-fill' : 'bi bi-pencil-fill' }}"></i>
                {{ $moneyBorrowing == null ? 'CREATION EMPRUNT' : 'MODIFICATION EMPRUNT' }}
            </h4>

        </div>
        <div class="card-body">
            <div class="d-flex justify-content-center pb-2">
                <x-widget.loading-circular-md wire:loading wire:target='getmoneyBorrowing' />
