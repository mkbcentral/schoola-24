<div>
    ...
    <x-content.main-content-page>
        <div
            class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
            {{-- Header avec breadcrumb --}}
            <div
                class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40 backdrop-blur-sm bg-white/95 dark:bg-gray-800/95">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between flex-wrap gap-4">
                        <div class="flex items-center gap-4">
                            <label
                                class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wide">Type
                                de dépense</label>
                            <div class="relative inline-flex items-center" x-data="{ checked: @entangle('expenseType').live === 'school_fee' }">
                                <input type="checkbox" wire:model.live="expenseType" class="sr-only peer"
                                    value="school_fee" x-model="checked">
                                <div class="w-20 h-10 rounded-full shadow-inner cursor-pointer transition-all duration-300 peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800"
                                    :class="checked ? 'bg-gradient-to-r from-green-400 to-emerald-500' :
                                    ...
                                    <div class="absolute top-1 left-1 bg-white rounded-full h-8 w-8 shadow-md transition-transform duration-300 flex items-center justify-center"
                                        ...
                                        <i class="bi"
                                            :class="checked ? 'bi-check-circle-fill text-green-600' :
                                                'bi-circle text-yellow-600'"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center gap-3">
                                <span class="px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200"
                                    :class="$wire.expenseType === 'other' ?
                                ...
                                <span class="px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200"
                                    :class="$wire.expenseType === 'school_fee' ?
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {{-- Total Dépenses --}}
                    <div
                        class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden relative">
                        <div
                            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-500 to-blue-600 opacity-10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500">
                        </div>
                        <div class="relative">
                            <div class="flex items-start justify-between mb-4">
                                <div
                                    class="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    <i class="bi bi-cash-stack text-blue-600 dark:text-blue-400 text-xl"></i>
                                </div>
                            </div>
                            <h3
                                class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2 uppercase tracking-wide">
                                Nombre de dépenses
                            </h3>
                    ...
                    <div
                        class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden relative">
                        <div
                            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-500 to-emerald-600 opacity-10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500">
                        </div>
                        <div class="relative">
                            <div class="flex items-start justify-between mb-4">
                                <div
                                    class="w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    <i class="bi bi-currency-dollar text-green-600 dark:text-green-400 text-xl"></i>
                                </div>
                                <span
                                    class="px-2.5 py-1 bg-gray-100 dark:bg-gray-700 rounded-lg text-xs font-medium text-gray-600 dark:text-gray-400">
                                    USD
                                </span>
                            </div>
                            <h3
                    ...
                    <div
                        class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden relative">
                        <div
                            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-purple-500 to-pink-600 opacity-10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500">
                        </div>
                        <div class="relative">
                            <div class="flex items-start justify-between mb-4">
                                <div
                                    class="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div
                        class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden relative">
                        <div
                            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-orange-500 to-red-600 opacity-10 rounded-full blur-2xl -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500">
                        </div>
                        <div class="relative">
                            <div class="flex items-start justify-between mb-4">
                                <div
                                    class="w-12 h-12 bg-orange-100 dark:bg-orange-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                        ...
                        <div class="flex-1 relative">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="search"
                                ...
                                class="w-full pl-11 pr-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 placeholder-gray-400 transition-all duration-200">
                        </div>

                        {{-- Boutons d'actions --}}
                        <div class="flex items-center gap-3">
                            <button type="button" data-bs-toggle="offcanvas" data-bs-target="#advancedFiltersOffcanvas"
                                class="px-5 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-medium rounded-xl transition-all duration-200 flex items-center gap-2 whitespace-nowrap shadow-lg">
                                ...
                                @if (
                                    $date ||
                                        ...
                                        $dateRange === 'custom')
                                    <span
                                        class="ml-1 px-2 py-0.5 bg-white/20 backdrop-blur-sm text-white text-xs rounded-full font-semibold">
                                        {{ collect([$date, $filterPeriod, $filterCurrency, $filterCategoryExpense, $filterCategoryFee, $filterOtherSource, $filterMonth, $filterIsValidated])->filter()->count() + ($dateRange === 'custom' ? 1 : 0) }}
                                    </span>
                                @endif
                            </button>
                            ...
                            @if (
                                ...
                                <button wire:click="resetFilters"
                                    class="px-5 py-3 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 text-red-700 dark:text-red-300 font-medium rounded-xl transition-all duration-200 flex items-center gap-2 whitespace-nowrap">
                    ...
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between flex-wrap gap-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">Liste des dépenses
                                    </h3>
                                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $expenses->total() }}
                                        dépense(s)
                                        trouvée(s)</p>
                                </div>
                            </div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($expenses as $expense)
                                    <tr
                                        class="group hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors duration-150 {{ $expense->is_validated ? 'bg-green-50/50 dark:bg-green-900/10' : '' }}">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium {{ $expense->currency === 'USD' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300' }}">
                                                {{ $expense->currency }}
                                            </span>
                                        </td>
                                        @if ($expenseType === 'school_fee')
                                        ...
                                        <td class="px-6 py-4">
                                            <label
                                                ...
                                                <input type="checkbox"
                                                    ...
                                                    class="sr-only peer">
                                                <div
                                                    class="w-14 h-7 bg-gradient-to-r from-gray-300 to-gray-400 peer-checked:from-green-400 peer-checked:to-emerald-500 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 transition-all duration-300 shadow-inner">
                                                    <div
                                                        class="absolute top-0.5 left-0.5 bg-white rounded-full h-6 w-6 shadow-md transition-transform duration-300 peer-checked:translate-x-7 flex items-center justify-center">
                                                        <i
                                                            class="bi text-xs {{ $expense->is_validated ? 'bi-check-lg text-green-600' : 'bi-x-lg text-gray-400' }}"></i>
                                                    </div>
                                                </div>
                                            </label>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="{{ $expenseType === 'school_fee' ? '9' : '8' }}"
                                            ...
                                            <div class="flex flex-col items-center gap-3">
                                                ...
                                                <p class="text-gray-500 dark:text-gray-400 font-medium">Aucune dépense
                                                    trouvée</p>
                                                <button wire:click="openCreateModal"
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                <div class="text-sm text-gray-600 dark:text-gray-400">
                                    Affichage de
                                    <span
                                        class="font-semibold text-gray-900 dark:text-gray-100">{{ $expenses->firstItem() }}</span>
                                    à
                                    <span
                                        class="font-semibold text-gray-900 dark:text-gray-100">{{ $expenses->lastItem() }}</span>
                                    sur
                                    <span
                                        class="font-semibold text-gray-900 dark:text-gray-100">{{ $expenses->total() }}</span>
                                    résultats
                                </div>
                                ...
                                <nav class="flex items-center gap-1">
                                    ...
                                    @if ($expenses->onFirstPage())
                                        <span
                                            class="px-3 py-2 text-sm font-medium text-gray-400 dark:text-gray-600 bg-gray-100 dark:bg-gray-800 rounded-lg cursor-not-allowed">
                                    ...
                                    @foreach ($expenses->getUrlRange(max(1, $expenses->currentPage() - 2), min($expenses->lastPage(), $expenses->currentPage() + 2)) as $page => $url)
                                        @if ($page == $expenses->currentPage())
                                            <span
                                                class="px-4 py-2 text-sm font-bold text-white bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-md">
                                                {{ $page }}
                                            </span>
                                        @else
                ...
                {{-- Taux de change --}}
                <div
                    class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl shadow-lg border border-blue-200 dark:border-blue-800 p-6">
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <p class="text-sm font-medium text-blue-700 dark:text-blue-300 mb-1">Taux de change actuel
                            </p>
            ...
            <div x-data="{
                ...
                @close-expense-form-modal.window="showExpenseModal = false" x-cloak
                ...
                <div class="flex min-h-screen items-center justify-center p-4">
                    <div @click.away="showExpenseModal = false"
                        ...
                        {{-- Header --}}
                        <div
                            class="bg-gradient-to-r from-blue-600 via-blue-500 to-purple-600 px-6 py-5 relative overflow-hidden">
                            <div class="absolute inset-0 bg-white/5"></div>
                            <div
                                class="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2">
                            </div>
                            <div
                                class="absolute bottom-0 left-0 w-40 h-40 bg-black/5 rounded-full translate-y-1/2 -translate-x-1/2">
                            </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="text-xl font-bold text-white"
                                            x-text="expenseType === 'school_fee' ? 'Dépense sur Frais Scolaires' : 'Autre Dépense'">
                                        </h3>
                        ...
                        {{-- Footer --}}
                        <div
                            class="bg-gradient-to-r from-gray-50 to-gray-100/80 dark:from-gray-700/80 dark:to-gray-700/60 backdrop-blur-sm px-6 py-4 border-t border-gray-200/50 dark:border-gray-600/50 flex justify-end gap-3">
                            <button @click="showExpenseModal = false"
                            ...
                            <button wire:click="saveExpense" wire:loading.attr="disabled"
                                ...
                                <svg wire:loading wire:target="saveExpense" class="animate-spin h-5 w-5 text-white"
            ...
            {{-- Offcanvas pour filtres --}}
            <div class="offcanvas offcanvas-end" tabindex="-1" id="advancedFiltersOffcanvas" style="width: 420px;">
                <div class="offcanvas-header bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-4">
                    <h5 class="offcanvas-title font-bold text-lg flex items-center gap-2">
                        <i class="bi bi-funnel-fill"></i>
                        Filtres des dépenses
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas"></button>
                </div>
                <div class="offcanvas-body p-4 bg-gray-50 dark:bg-gray-900">
                    <div class="space-y-5">
                        {{-- Section: Période --}}
                        <div
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <input type="date" wire:model.live="date"
                                        class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 text-sm">
                                </div>

                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Période
                                        prédéfinie</label>
                                    <select wire:model.live="filterPeriod"
                                        class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-gray-100 text-sm">
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Plage
                                        personnalisée</label>
                                ...
                                @if ($dateRange === 'custom')
                                    <div class="grid grid-cols-2 gap-3 pl-4 border-l-2 border-blue-500">
                                        <div>
                                            <label
                                                class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Du</label>
                                            <input type="date" wire:model.live="dateDebut"
                                                class="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-gray-100 text-sm">
                                        </div>
                                        <div>
                                            <label
                                                class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">Au</label>
                        ...
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
                            <h6 class="font-semibold text-gray-900 dark:text-gray-100 mb-3 flex items-center gap-2">
                                <i class="bi bi-tag-fill text-purple-500"></i>
                                Catégories
                            </h6>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Catégorie
                                        générale</label>
                                ...
                                @else
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Source
                                            de dépense</label>
                        ...
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
                            <h6 class="font-semibold text-gray-900 dark:text-gray-100 mb-3 flex items-center gap-2">
                                <i class="bi bi-gear-fill text-green-500"></i>
                                Autres critères
                            </h6>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Devise</label>
                                ...
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Statut
                                        de validation</label>
                        ...
                        <div class="flex gap-3 pt-2">
                            <button wire:click="resetFilters" data-bs-dismiss="offcanvas"
                                class="flex-1 px-4 py-3 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-xl transition-all duration-200 flex items-center justify-center gap-2">
                                <i class="bi bi-arrow-counterclockwise"></i>
                                Réinitialiser
                            </button>
                            <button data-bs-dismiss="offcanvas"
                                class="flex-1 px-4 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg transition-all duration-200 flex items-center justify-center gap-2">
