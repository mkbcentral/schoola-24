<div>
    <div class="card">
        <div class="card-header">
            <h4>
                <i class="{{ $expenseFee == null ? 'bi bi-plus-circle-fill' : 'bi bi-pencil-fill' }}"></i>
                {{ $expenseFee == null ? 'CREATION DEPENSE' : 'MODIFICATION DEPENSE' }}
            </h4>

        </div>
        <div class="card-body">
            <div class="d-flex justify-content-center pb-2">
                <x-widget.loading-circular-md wire:loading wire:target='getexpenseFee' />
            ...
            <form wire:submit='handlerSubmit'>
                ...
                <div class="row">
                    ...
                    <div class="mt-2 col">
                        ...
                        <x-widget.data.list-category-expense type='text' wire:model.live='form.category_expense_id'
