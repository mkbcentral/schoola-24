<div>
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <x-form.app-button wire:click='newBankDeposit' data-bs-toggle="modal" data-bs-target="#form-bank-deposit"
                            ...
                            @can('manage-payment')
                                <x-others.dropdown wire:ignore.self icon="bi bi-three-dots-vertical"
                                    ...
                                    <x-others.dropdown-link iconLink='bi bi-pencil-fill' labelText='Editer' href="#"
                                        wire:click='edit({{ $bankDeposit }})' data-bs-toggle="modal"
                                        data-bs-target="#form-bank-deposit" />
