    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center">
                <div>
                    <h3 class="font-bold text-2xl text-gray-900 dark:text-gray-100">
                        <i class="bi bi-graph-up-arrow text-blue-600 dark:text-blue-400"></i>
                        DASHBOARD FINANCIER
                    </h3>
                    <p class="text-gray-600 dark:text-gray-400">Vue d'ensemble des recettes et dépenses</p>
                </div>
                <div class="flex gap-2">
                    {{-- Toggle de devise --}}
                    <button class="px-4 py-2 text-lg rounded transition-colors {{ $currency === 'USD' ? 'bg-blue-600 text-white shadow-md' : 'border-2 border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 bg-white dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-gray-700' }}"
                        wire:click='toggleCurrency'>
                        <i class="bi bi-currency-dollar"></i> USD
                    </button>
                    <button class="px-4 py-2 text-lg rounded transition-colors {{ $currency === 'CDF' ? 'bg-green-600 text-white shadow-md' : 'border-2 border-green-600 dark:border-green-400 text-green-600 dark:text-green-400 bg-white dark:bg-gray-800 hover:bg-green-50 dark:hover:bg-gray-700' }}"
                        wire:click='toggleCurrency'>
